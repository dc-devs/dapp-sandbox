...
import WalletConnectGeneric from './wallet-connect-generic';
import WalletConnectMetaMask from './wallet-connect-metamask';
...
const WalletConnectModal = ({ isOpen }: Props) => {
